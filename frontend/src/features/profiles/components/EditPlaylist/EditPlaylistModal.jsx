  ...
  return (
    <Modal onClose={onClose}>
      <div className="edit-playlist-modal-container">
        <header className="edit-playlist-modal-header">
          <nav>
            <ul className="edit-playlist-modal-tabs">
              <li className="edit-playlist-modal-tab selected">Basic info</li>
              <li className="edit-playlist-modal-tab">Tracks</li>
            </ul>
          </nav>
        </header>
          ...
          <div className="grid-form">
            ...
            >
              <label
                htmlFor="cover"
                role="button"
                className="playlist-cover-trigger"
              >
                <input
                  type="file"
                  id="cover"
